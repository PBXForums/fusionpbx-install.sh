...
apt-get install -y sudo bison flex libreadline-dev uuid-dev gettext postgresql-common
DEBIAN_FRONTEND=noninteractive apt install -y postgresql-client-9.4
